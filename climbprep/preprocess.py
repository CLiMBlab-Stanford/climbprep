...
if __name__ == '__main__':
    ...
    argparser.add_argument('subject', help='BIDS participant ID')
    ...
    work_path = os.path.join(WORK_PATH, args.project, args.subject)

    cmd = f'fmriprep {project_path} {out_path} participant -w {work_path} --participant-label {args.subject} --fs-license-file {args.fs_license_file}'
